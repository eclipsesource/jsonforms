...
export const mockOverlayPortal = (app: App, config: Config, plt: PlatformMock): OverlayPortal => {
    const zone = mockZone();
...
export const mockIonicApp = (app: App, config: Config, plt: PlatformMock): IonicApp => {
...
export const mockDeepLinker = (linkConfig: DeepLinkConfig = null, app?: App) => {
...
export const mockTransitionController = (config: Config): TransitionController => {
