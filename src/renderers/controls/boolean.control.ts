...
@JsonFormsRenderer({
  ...
  tester: (uischema: UISchemaElement, schema: JsonSchema) => uischema.type === "Control" && PathUtil.getResolvedSchema(schema, (<ControlElement>uischema).scope.$ref).type === "boolean" ? 2 : -1
})
