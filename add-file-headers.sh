...
function print_usage {
  show_status usage "$0 [all|git-dirty] [-p|--path=/path/to/src]"
  show_status usage "Example: $0 all --path=/lib # Will add headers to all supported file types in /lib directory"
}
