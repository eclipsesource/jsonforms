...
With version 3.0 of JSON Forms, we no longer include `json-schema-ref-parser` within the core package. For a migration guide, have a look <a href="https://github.com/eclipsesource/jsonforms/blob/master/MIGRATION.md">here</a>.
