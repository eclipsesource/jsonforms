...
export declare class FormController {
    ...
    constructor(rendererService: RendererService, UISchemaRegistry: UiSchemaRegistry, RootDataService: RootDataService, SchemaGenerator: ISchemaGenerator, $compile: ng.ICompileService, $q: ng.IQService, scope: JsonFormsDirectiveScope);
    init(): void;
...
export declare class JsonFormsDirective implements ng.IDirective {
    ...
    constructor(RootDataService: RootDataService);
}
