...
export declare class FormController {
    ...
    constructor(rendererService: RendererService, PathResolver: IPathResolver, UISchemaRegistry: UiSchemaRegistry, SchemaGenerator: ISchemaGenerator, $compile: ng.ICompileService, $q: ng.IQService, scope: JsonFormsDirectiveScope);
    init(): void;
