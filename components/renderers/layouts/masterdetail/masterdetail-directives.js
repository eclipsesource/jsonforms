...
var MasterDetailController = (function (_super) {
    ...
    function MasterDetailController(scope, pathResolver) {
        var _this = this;
...
var MasterDetailControlRendererTester = function (element, dataSchema, dataObject, pathResolver) {
...
exports.default = angular
    ...
    .run(['RendererService', function (RendererService) {
        return RendererService.register('master-detail', MasterDetailControlRendererTester);
    }
])
