...
var ReferenceController = (function (_super) {
    ...
    Object.defineProperty(ReferenceController.prototype, "link", {
        get: function () {
            var normalizedPath = jsonforms_pathresolver_1.PathResolver.toInstancePath(this.schemaPath);
...
exports.default = angular
    ...
    .run(['RendererService', function (RendererService) {
        return RendererService.register('reference-control', abstract_control_1.uiTypeIs('ReferenceControl'), 2);
    }
])
    .name;
