...
var AbstractControl = (function () {
    function AbstractControl(scope) {
        ...
        this.scope = scope;
        this.alerts = [];
        this.pathResolver = new jsonforms_pathresolver_1.PathResolver();
...
function schemaTypeIs(expected) {
    return function (uiSchema, schema, data) {
        ...
        var currentDataSchema = new jsonforms_pathresolver_1.PathResolver().resolveSchema(schema, schemaPath);
...
var RendererTesterBuilder = (function () {
    ...
    RendererTesterBuilder.prototype.none = function (uiSchema, schema, data) {
        return renderer_service_1.NOT_FITTING;
    };
    ;
