...
exports.default = angular
    ...
    .run(['RendererService', function (RendererService) {
        return RendererService.register('datetime-control', testers_1.Testers.and(testers_1.schemaTypeIs('string'), testers_1.schemaTypeMatches(function (el) { return _.has(el, 'format') && el['format'] === 'date-time'; })), 10);
    }
])
