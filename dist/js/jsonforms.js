/*! jsonforms - v0.0.8 - 2015-12-01 Copyright (c) EclipseSource Muenchen GmbH and others. */ 
'use strict';
...
(function (JSONForms) {
    ...
    var RenderDescriptionFactory = (function () {
        ...
        RenderDescriptionFactory.createControlDescription = function (schemaPath, services, label, rule) {
        ...
        RenderDescriptionFactory.createContainerDescription = function (size, elements, template, services, rule) {
    ...
    var ContainerRenderDescription = (function () {
        function ContainerRenderDescription(size, elements, template, services, rule) {
            this.size = size;
    ...
    var ControlRenderDescription = (function () {
        function ControlRenderDescription(schemaPath, services, label, rule) {
...
///<reference path="../references.ts"/>
angular.module('jsonforms.renderers').directive('widget', function () {
    return {
        restrict: "E",
        replace: true,
        transclude: true,
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  ///<reference path="../../references.ts"/>
  module.directive('control', function () {
      return {
          restrict: "E",
          replace: true,
          transclude: true,
...
///<reference path="../../references.ts"/>
angular.module('jsonforms.renderers.layouts').directive('layout', function () {
    return {
        restrict: "E",
        replace: true,
        transclude: true,
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  var FormController = (function () {
      function FormController(RenderService, PathResolver, UISchemaGenerator, SchemaGenerator, $scope, $q) {
          this.RenderService = RenderService;
          this.PathResolver = PathResolver;
      ...
      FormController.prototype.init = function () {
          ...
          this.$q.all([resolvedSchemaDeferred.promise, resolvedUISchemaDeferred.promise, this.fetchData()]).then(function (values) {
              ...
              var dataProvider;
              if (_this.$scope.asyncDataProvider) {
                  dataProvider = _this.$scope.asyncDataProvider;
              }
              else {
                  dataProvider = new JSONForms.DefaultDataProvider(_this.$q, data);
              }
              services.add(dataProvider);
              _this.$scope['elements'] = [_this.RenderService.render(_this.$scope, uiSchema, services)];
          });
      };
      ...
      FormController.$inject = ['RenderService', 'PathResolver', 'UISchemaGenerator', 'SchemaGenerator', '$scope', '$q'];
      return FormController;
  })();
  module.directive('jsonforms', function () {
      return {
          restrict: "E",
          replace: true,
          scope: {
          ...
          link: function (scope, el, attrs, ctrl) {
              scope['element'] = el;
              scope.$watch('uiSchema', function () { ctrl.init(); });
              scope.$watch('data', function () { ctrl.init(); });
          }
      };
  });
...
//====================================================================================================================
// Module:    jsonforms.renderers.controls.autocomplete
// Optimized: Yes
// File:      components/renderers/controls/autocomplete/autocomplete.js
//====================================================================================================================
...
//--------------------------------------------------------------------------------------------------------------------
// File: components/renderers/controls/autocomplete/autocomplete-directive.js
//--------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------
// File: components/renderers/controls/autocomplete/autocomplete-renderer.js
//--------------------------------------------------------------------------------------------------------------------
  ...
  var AutoCompleteRenderer = (function () {
      ...
      AutoCompleteRenderer.prototype.render = function (element, schema, schemaPath, services) {
      ...
      AutoCompleteRenderer.prototype.isApplicable = function (uiElement, subSchema, schemaPath) {
...
}) (angular.module ('jsonforms.renderers.controls.autocomplete', ['jsonforms.renderers.controls']));
...
angular.module('jsonforms.renderers.layouts.masterdetail')
    .directive('masterdetailCollection', function () {
    return {
        restrict: "E",
        replace: true,
        scope: {
    ...
    .directive('masterdetailMember', function ($compile) {
    return {
        restrict: "E",
        replace: true,
        scope: {
        ...
        link: function (scope, element, attrs) {
            $compile('<masterdetail-collection collection="member.properties" element="element"></masterdetail-collection>')(scope, function (cloned, scope) {
...
var MasterDetailRenderer = (function () {
    function MasterDetailRenderer(renderService) {
        this.renderService = renderService;
        this.priority = 1;
    }
...
angular.module('jsonforms.renderers.layouts.masterdetail').run(['RenderService', function (RenderService) {
...
$templateCache.put('components/form/form.html',
    "<div><form role=\"form\" class=\"jsf-form rounded\"><dynamic-widget ng-repeat=\"child in elements\" element=\"child\"></dynamic-widget></form></div>"
  );
