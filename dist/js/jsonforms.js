/*! jsonforms - v0.0.2 - 2015-10-29 Copyright (c) EclipseSource Muenchen GmbH and others. */ 
'use strict';
// Source: js/app.js
...
var JsonFormsDirectiveController = (function () {
    function JsonFormsDirectiveController(RenderService, PathResolver, UISchemaGenerator, SchemaGenerator, $scope, $q) {
    ...
    JsonFormsDirectiveController.$inject = ['RenderService', 'PathResolver', 'UISchemaGenerator', 'SchemaGenerator', '$scope', '$q'];
    return JsonFormsDirectiveController;
})();
jsonFormsDirectives.directive('jsonforms', function () {
    return {
        restrict: "E",
        replace: true,
        scope: {
    ...
    .directive('dynamicWidget', ['$compile', '$templateRequest', function ($compile, $templateRequest) {
        var replaceJSONFormsAttributeInTemplate = function (template, fragments) {
            var path = [];
...
var ArrayControl = (function () {
    function ArrayControl(pathResolver, scope) {
        this.pathResolver = pathResolver;
        this.scope = scope;
        this.maxSize = 99;
        this.priority = 2;
...
// Source: js/renderers/AutoCompleteControl.js
///<reference path="..\services.ts"/>
var AutoCompleteControl = (function () {
    function AutoCompleteControl() {
        this.priority = 3;
    }
    AutoCompleteControl.prototype.render = function (element, schema, schemaPath, dataProvider) {
    ...
    AutoCompleteControl.prototype.isApplicable = function (uiElement, subSchema, schemaPath) {
        var isApplicable = uiElement.type == 'Control' && uiElement.hasOwnProperty("suggestion");
        return isApplicable;
    };
    return AutoCompleteControl;
})();
var app = angular.module('jsonforms.autoCompleteControl', []).directive('autoComplete', function ($timeout) {
...
// Source: js/renderers/Categorization.js
/// <reference path="../../typings/angularjs/angular.d.ts"/>
/// <reference path="../services.ts"/>
var Categorization = (function () {
    function Categorization(renderService) {
        this.renderService = renderService;
        this.priority = 1;
    }
    Categorization.prototype.render = function (element, subSchema, schemaPath, dataProvider) {
        var _this = this;
        var renderElements = function (elements) {
            if (elements === undefined || elements.length == 0) {
                ...
                return elements.reduce(function (acc, curr, idx, els) {
                    acc.push(_this.renderService.render(curr, dataProvider));
                    return acc;
                }, []);
            }
        };
    ...
    Categorization.prototype.isApplicable = function (uiElement, jsonSchema, schemaPath) {
...
var Category = (function () {
    function Category(renderService) {
        this.renderService = renderService;
        this.priority = 1;
    }
    Category.prototype.render = function (element, subSchema, schemaPath, dataProvider) {
        var _this = this;
        var renderElements = function (elements) {
            if (elements === undefined || elements.length == 0) {
                return [];
    ...
    Category.prototype.isApplicable = function (uiElement, jsonSchema, schemaPath) {
...
var DatetimeControl = (function () {
    ...
    DatetimeControl.prototype.render = function (element, schema, schemaPath, dataProvider) {
        var control = new JSONForms.ControlRenderDescription(dataProvider.data, schemaPath, element.label);
...
var EnumControl = (function () {
    function EnumControl(pathResolver) {
        this.pathResolver = pathResolver;
        this.priority = 3;
    }
    EnumControl.prototype.render = function (element, schema, schemaPath, dataProvider) {
        var subSchema = this.pathResolver.resolveSchema(schema, schemaPath);
        ...
        this.render = function (element, subSchema, schemaPath, dataProvider) {
            var renderElements = function (elements) {
                if (elements === undefined || elements.length == 0) {
                    ...
                    return elements.reduce(function (acc, curr, idx, els) {
                        acc.push(_this.renderServ.render(curr, dataProvider));
                        return acc;
                    }, []);
                }
            };
...
(function (JSONForms) {
    ...
    var PathResolver = (function () {
        ...
        function PathResolver($compile) {
            ...
            this.resolveInstance = function (instance, path) {
                var fragments = PathUtil.toPropertyFragments(_this.toInstancePath(path));
    ...
    var RenderDescriptionFactory = (function () {
        ...
        RenderDescriptionFactory.createControlDescription = function (data, schemaPath, label) {
...
$templateCache.put('templates/control.html',
    "<div class=\"col-sm-{{element.size}} form-group top-buffer\"><div class=\"row\"><label ng-if=\"element.label\" for=\"element.id\">{{element.label}}</label></div><div class=\"row\" style=\"padding-right: 1em\" ng-transclude></div><div class=\"row\" style=\"padding-right: 1em\"><alert ng-repeat=\"alert in element.alerts\" type=\"{{alert.type}}\" class=\"top-buffer-s jsf-alert\">{{alert.msg}}</alert></div></div>"
  );


  $templateCache.put('templates/form.html',
    "<div><form role=\"form\" class=\"jsf-form rounded\"><dynamic-widget ng-repeat=\"child in elements\" element=\"child\" bindings=\"bindings\" top-open-date=\"openDate\" top-validate-number=\"validateNumber\" top-validate-integer=\"validateInteger\"></dynamic-widget></form></div>"
  );


  $templateCache.put('templates/layout.html',
    "<div class=\"col-sm-{{element.size}}\" ng-transclude></div>"
  );
