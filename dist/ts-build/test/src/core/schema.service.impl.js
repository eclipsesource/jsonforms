...
const path_util_2 = require("../path.util");
...
const addToArray = (key, identifyingProperty) => (data) => (valueToAdd, neighbourValue, insertAfter = true) => {
...
class SchemaServiceImpl {
    ...
    selfContainSchema(schema, outerSchema, outerReference, includedDefs = ['#']) {
        ...
        const allInnerRefs = path_util_2.findAllRefs(schema);
