...
exports.getValuePropertyPair = (instance, schemaPath) => {
    const validPathSegments = exports.toDataPathSegments(schemaPath);
...
exports.composeWithUi = (scopableUi, path) => {
    const segments = exports.toDataPathSegments(scopableUi.scope.$ref);
    return _.isEmpty(segments) ? path : exports.compose(path, segments.join('.'));
};
exports.resolveData = (data, path) => _.isEmpty(path) ? data : _.get(data, path);
/**
