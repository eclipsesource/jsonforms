...
let VerticalLayoutRenderer = class VerticalLayoutRenderer extends renderer_1.Renderer {
    ...
    render() {
        ...
        div.className = core_1.JsonForms.stylingRegistry.getAsClassName('vertical-layout');
        ...
        for (let i = 0; i < childrenSize; i++) {
            const itemStyle = core_1.JsonForms.stylingRegistry.getAsClassName('vertical-layout-item', childrenSize);
