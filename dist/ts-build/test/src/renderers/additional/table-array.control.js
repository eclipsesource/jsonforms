...
let TableArrayControlRenderer = class TableArrayControlRenderer extends renderer_1.Renderer {
    ...
    render() {
        ...
        label.className = core_1.JsonForms.stylingRegistry.getAsClassName('array-table.label');
        ...
        this.className = core_1.JsonForms.stylingRegistry.getAsClassName('array-table.table');
        ...
        button.className = core_1.JsonForms.stylingRegistry.getAsClassName('array-table.button');
        ...
        this.className = core_1.JsonForms.stylingRegistry.getAsClassName('array-table');
