...
ava_1.default('BooleanControl static', t => {
    ...
    const label = result.children[1];
    t.is(label.tagName, 'LABEL');
    t.is(label.textContent, 'Foo');
    const input = result.children[0];
...
ava_1.default('BooleanControl dataService notification', t => {
    ...
    const input = renderer.children[0];
...
ava_1.default('BooleanControl notify disabled', t => {
    base_control_tests_1.testDisable(t, new boolean_control_1.BooleanControl(), 0);
});
ava_1.default('BooleanControl notify enabled', t => {
    base_control_tests_1.testEnable(t, new boolean_control_1.BooleanControl(), 0);
});
...
ava_1.default('BooleanControl disconnected no notify enabled', t => {
    base_control_tests_1.testNotifyAboutEnablementWhenDisconnected(t, new boolean_control_1.BooleanControl(), 0);
});
