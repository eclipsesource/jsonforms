...
var EnumControl = /** @class */ (function (_super) {
    ...
    EnumControl.prototype.render = function () {
        var _a = this.props, uischema = _a.uischema, schema = _a.schema, classNames = _a.classNames, id = _a.id, label = _a.label, visible = _a.visible, enabled = _a.enabled, data = _a.data, dispatch = _a.dispatch, path = _a.path, errors = _a.errors;
        ...
        return (JSX_1.JSX.createElement("div", { className: classNames.wrapper },
            ...
            JSX_1.JSX.createElement("select", { className: classNames.input, hidden: !visible, disabled: !enabled, value: data, onInput: function (ev) { return dispatch(actions_1.update(path, function () { return ev.target.value; })); } }, [JSX_1.JSX.createElement("option", { value: '', selected: data === undefined })]
...
exports.default = renderer_util_1.registerStartupRenderer(exports.enumControlTester, inferno_redux_1.connect(renderer_util_1.mapStateToControlProps)(EnumControl));
