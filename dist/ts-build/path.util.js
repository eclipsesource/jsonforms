...
exports.getValuePropertyPair = function (instance, schemaPath) {
    var validPathSegments = exports.toDataPathSegments(schemaPath);
...
exports.composeWithUi = function (scopableUi, path) {
    var segments = exports.toDataPathSegments(scopableUi.scope.$ref);
    return _.isEmpty(segments) ? path : exports.compose(path, segments.join('.'));
};
exports.resolveData = function (data, path) {
    return _.isEmpty(path) ? data : _.get(data, path);
};
/**
