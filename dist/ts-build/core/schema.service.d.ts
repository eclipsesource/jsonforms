...
export declare class ReferencePropertyImpl implements ReferenceProperty {
    ...
    private addFunction;
    private getFunction;
    constructor(innerSchema: JsonSchema, innerTargetSchema: JsonSchema, key: string, name: string, addFunction: (root: object, data: object, valueToAdd: object) => void, getFunction: (root: object, data: object) => Object);
    readonly label: string;
    readonly schema: JsonSchema;
    readonly property: string;
    readonly targetSchema: JsonSchema;
